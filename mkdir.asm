...
printint(int fd, int xx, int base, int sgn)
{
 ...
 451:	0f b6 91 4c 0e 00 00 	movzbl 0xe4c(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 58b:	75 25                	jne    5b2 <printf+0xff>
          s = "(null)";
 58d:	c7 45 f4 a4 0a 00 00 	movl   $0xaa4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 654:	a1 68 0e 00 00       	mov    0xe68,%eax
 ...
 71f:	a3 68 0e 00 00       	mov    %eax,0xe68
}
 724:	90                   	nop
 725:	c9                   	leave
 726:	c3                   	ret
...
morecore(uint nu)
{
 ...
 77d:	83 c4 10             	add    $0x10,%esp
  return freep;
 780:	a1 68 0e 00 00       	mov    0xe68,%eax
}
 785:	c9                   	leave
 786:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 799:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 79c:	a1 68 0e 00 00       	mov    0xe68,%eax
 7a1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a8:	75 23                	jne    7cd <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7aa:	c7 45 f0 60 0e 00 00 	movl   $0xe60,-0x10(%ebp)
 7b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b4:	a3 68 0e 00 00       	mov    %eax,0xe68
 7b9:	a1 68 0e 00 00       	mov    0xe68,%eax
 7be:	a3 60 0e 00 00       	mov    %eax,0xe60
    base.s.size = 0;
 7c3:	c7 05 64 0e 00 00 00 	movl   $0x0,0xe64
 7ca:	00 00 00 
  }
 ...
 820:	a3 68 0e 00 00       	mov    %eax,0xe68
      return (void*)(p + 1);
 ...
 82b:	eb 3b                	jmp    868 <malloc+0xe1>
    ...
    if(p == freep)
 82d:	a1 68 0e 00 00       	mov    0xe68,%eax
